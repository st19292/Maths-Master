...
class MathsMasterApp:
    ...
    def __init__(self):
        ...
        self.middle_buttons_frame = Frame(self.root, bg=DARK, padx=10, pady=40)
        self.bottom_buttons_frame = Frame(self.root, bg=DARK, padx=10, pady=20)
    ...
    def menu_top_frame(self):
        ...
        subheading = Label(master=self.top_heading_frame, text=subheading_text,
                           font=(MAIN_FONT, "10"), bg=DARK, fg=WHITE, width=80)
    ...
    def menu_middle_frame(self):
        ...
        def subtract_button_clicked(click):
            self.root.destroy()
            QuizInterface("-")

        def multiply_button_clicked(click):
            self.root.destroy()
            QuizInterface("*")

        def divide_button_clicked(click):
            self.root.destroy()
            QuizInterface("/")

        # Creates Addition Widget
        canvas_add = Canvas(master=self.middle_buttons_frame,
                            width=82, height=82, bg=DARK,
        ...
        add_text = Label(master=self.middle_buttons_frame,
                         ...
                         bg=DARK, fg=WHITE, width=12)
        add_text.grid(row=2, column=0)

        # Sets Addition Command
        add_button = canvas_add.create_image(40, 40, image=self.add_add_img)
        canvas_add.tag_bind(add_button, "<Button>", add_button_clicked)
        self.root.bind('1', add_button_clicked)
        ...
        canvas_subtract.tag_bind(subtract_button,
                                 "<Button>", subtract_button_clicked)
        self.root.bind('2', subtract_button_clicked)
        ...
        canvas_multiply.tag_bind(multiply_button,
                                 "<Button>", multiply_button_clicked)
        self.root.bind('3', multiply_button_clicked)
        ...
        canvas_divide.tag_bind(divide_button,
                               "<Button>", divide_button_clicked)
        self.root.bind('4', divide_button_clicked)
    ...
    def menu_bottom_frame(self):
        ...
        exit_program_button = Button(master=self.bottom_buttons_frame,
                                     ...
                                     fg=BLACK, bg=WHITE,
                                     height=1, width=16, relief="flat",
                                     command=exit_program_button_clicked)
        ...
        help_and_info_button = Button(master=self.bottom_buttons_frame,
                                      ...
                                      fg=BLACK, bg=WHITE,
                                      height=1, width=16, relief="flat",
                                      command=help_and_info_button_clicked)
...
class QuizInterface:
    ...
    def __init__(self, operator):
        ...
        # Creates Top, Middle & Bottom Proximity Frame
        self.top_heading_frame = Frame(self.root, padx=10, pady=10, bg=DARK)
        self.middle_quiz_frame = Frame(self.root, bg=DARK, padx=10, pady=40)
        self.bottom_buttons_frame = Frame(self.root, bg=DARK, padx=10, pady=20)
    ...
    def menu_bottom_frame(self):
        ...
        return_to_menu_button = Button(master=self.bottom_buttons_frame,
                                       ...
                                       fg=BLACK, bg=WHITE,
                                       height=1, width=16, relief="flat",
                                       command=return_to_menu_button_clicked)
        return_to_menu_button.grid(row=5, column=0, padx=8, pady=10)
        self.root.bind('<Escape>',
                       lambda event: return_to_menu_button_clicked())
    ...
    def answer_check(self):
        ...
        try:
            ...
            if user_answer == correct_answer:
                self.feedback_text.config(text=f"Correct: {operation_str} is "
                                               f"{correct_answer}")
...
class HelpAndInfo:
    ...
    def menu_top_frame(self):
        ...
        main_heading = Label(master=self.top_heading_frame, text=heading_text,
                             font=(MAIN_FONT, "20", "bold"), bg=DARK,
                             fg=WHITE, width=30)
        main_heading.pack(pady=(10, 0))
    ...
    def menu_middle_frame(self):
        ...
        help_and_info = Label(master=self.middle_buttons_frame,
                              ...
                              font=(MAIN_FONT, "10",),
                              bg=DARK, fg=WHITE, wraplength=420)
...
class HistoryAndExport:
    ...
    def menu_top_frame(self):
        ...
        main_heading = Label(master=self.top_heading_frame, text=heading_text,
                             font=(MAIN_FONT, "20", "bold"), bg=DARK, fg=WHITE,
                             width=30)
        main_heading.pack(pady=(10, 0))
        ...
        subheading = Label(master=self.top_heading_frame, text=subheading_text,
                           font=(MAIN_FONT, "10"), bg=DARK, fg=WHITE,
                           width=80)
        subheading.pack(pady=(10, 0))
    ...
    def menu_middle_frame(self):
        ...
        corrected_answers_frame = Frame(self.root, padx=10, pady=10, bg=DARK)
        ...
        for row_num, answer in enumerate(self.answers_list):
            answer_label = Label(master=corrected_answers_frame, text=answer,
                                 font=(MAIN_FONT, "8"), bg=DARK, fg=WHITE,
                                 wraplength=80)
            answer_label.grid(row=row_num, column=0, padx=5, pady=0)

        # Export Entry Frame
        export_entry_frame = Frame(self.root, padx=10, pady=10, bg=DARK)
    ...
    def menu_bottom_frame(self):
        ...
        export_button = Button(master=self.bottom_buttons_frame, text="Export",
                               ...
                               fg=BLACK, bg=WHITE,
                               height=1, width=16,
                               relief="flat", command=naming_check)
